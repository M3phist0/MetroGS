...
from .vanilla_gaussian_offload import VanillaGaussian, VanillaGaussianModel, OptimizationConfig
from internal.optimizers_offload import OptimizerConfig
...
class Gaussian2DModel(Gaussian2DModelMixin, VanillaGaussianModel):
    ...
    def setup_from_number(self, n: int, *args, **kwargs):
        ...
        print("from number means device:", means.device)
    ...
    def setup_from_pcd(self, xyz: Union[torch.Tensor, np.ndarray], rgb: Union[torch.Tensor, np.ndarray], *args, **kwargs):
        ...
        print("from pcd means device:", means.device)
